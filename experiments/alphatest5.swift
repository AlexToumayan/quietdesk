...
func makePanel(_ v: NSView) -> NSWindow {
    let w = NSPanel(contentRect: NSRect(x: screen.frame.minX, y: screen.frame.minY, width: 1000, height: 700), styleMask: [.borderless, .nonactivatingPanel], backing: .buffered, defer: false)
...
let wb = makeWindow(bv), wa = makePanel(av)
